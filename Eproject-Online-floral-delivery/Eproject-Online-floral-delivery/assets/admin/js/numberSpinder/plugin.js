(function($) {
    $.fn.htmlNumberSpinner = function () {
        ...
        $(this).find('.btn').css({"display":"inline-block", "width":"50px", "height":"33px", "font-size":"20px", "text-align":"center", "vertical-align":"middle", "line-height":"0.5", "cursor":"pointer", "user-select":"none","color":"white"});
        incrementerEl$.css({"background-color":"black", "color":"white", "border": "1px solid slateblue"});
        decrementerEl$.css({"background-color":"black", "color":"white", "font-size":"25px", "border": "1px solid hotpink"});
        numberInput$.css({
